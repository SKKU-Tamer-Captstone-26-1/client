...
const mockMapPlaces = [
  ...
  MapPlace(
    ...
    category: 'Rare Finds',
    layerCode: 'liquor_shop',
    address: 'North Hills',
    distanceLabel: '1.2 miles away',
    rating: '4.7',
    status: 'Open now - Closes 10PM',
    latitude: 37.5651,
    longitude: 126.9826,
    imageUrls: [
    ...
    tags: ['Gin', 'Bottle Shop'],
  ),
  MapPlace(
    id: 'terrace-vault',
    name: 'The Terrace Vault',
    category: 'Outdoor Tasting',
    layerCode: 'outdoor_spot',
    address: 'West Village Terrace',
