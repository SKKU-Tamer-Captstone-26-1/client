...
typedef MapPositionResolver = Future<LatLng?> Function();
...
class MapScreen extends StatefulWidget {
  ...
  final MapApiDataSource? dataSource;
  final MapPositionResolver? positionResolver;
...
class _MapScreenState extends State<MapScreen> {
  late final MapApiDataSource _api;
  ...
  void initState() {
    super.initState();
    _api = widget.dataSource ?? MapApiDataSource();
  ...
  Future<LatLng?> _resolveGpsPosition() async {
    final injectedResolver = widget.positionResolver;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _locationLoading
          ? const AppLoadingIndicator(label: '지도 불러오기')
          : Stack(
              children: [
                Positioned.fill(
                  child: KakaoMapView(
                  ...
                  Positioned(
                    ...
                    child: _PlaceInfoCard(
                      ...
                      onTap: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              PlaceDetailScreen(place: _selectedPlace!),
                        ),
                      ),
                    ),
                  ),
