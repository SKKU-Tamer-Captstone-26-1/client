...
class SurveyScreen extends ConsumerWidget {
  ...
  Future<void> _submitSurvey(
    ...
    final authToken = auth.accessToken?.trim() ?? '';
    if (auth.userId == null || authToken.isEmpty) {
    ...
    return ListView(
      ...
      children: [
        ...
        if (q.isMultiSelect && q.maxSelections != null) ...[
          ...
          _SubtitleText(state: state, selectedValues: selectedValues),
        ],
...
class _SubtitleText extends StatelessWidget {
  ...
  const _SubtitleText({required this.state, required this.selectedValues});
