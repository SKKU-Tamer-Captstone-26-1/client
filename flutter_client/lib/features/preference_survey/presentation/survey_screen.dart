...
class SurveyScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Onboarding', style: TextStyle(fontWeight: FontWeight.bold)),
        centerTitle: true,
        actions: [
          if (state.currentQuestion.id != 'q1' && state.currentQuestion.id != 'q2')
            TextButton(
  ...
  void _handleNext(BuildContext context, WidgetRef ref, SurveyState state, SurveyNotifier notifier) {
    if (state.isLast) {
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              valueColor: AlwaysStoppedAnimation(Theme.of(context).colorScheme.primaryContainer),
            ),
          ),
        ],
      ),
...
class _QuestionBody extends StatelessWidget {
  ...
  const _QuestionBody({super.key, required this.state, required this.onSelect, required this.onToggle});
    ...
    return ListView(
      ...
      children: [
        ...
        if (q.subtitle.isNotEmpty) ...[
          const SizedBox(height: 8),
          _SubtitleText(state: state, base: q.subtitle, selectedValues: selectedValues),
        ],
        ...
        ...q.options.map((opt) => Padding(
              ...
              child: OptionCard(
                ...
                onTap: () => q.isMultiSelect ? onToggle(opt.value) : onSelect(opt.value),
              ),
            )),
      ],
    );
...
class _SubtitleText extends StatelessWidget {
  ...
  const _SubtitleText({required this.state, required this.base, required this.selectedValues});
...
class _BottomControls extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isUnskippable = state.currentQuestion.id == 'q1' || state.currentQuestion.id == 'q2';
